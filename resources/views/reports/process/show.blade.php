                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                ...
                                <a href="{{ route('reports.process') }}" style="padding-left: 20px; padding-right: 20px"
                                    class="btn btn-sm btn-default" type="button" data-placement="top"
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($process as $item)
                                                <tr>
                                                    ...
                                                    <th class="hide_print">{{ number_format($item->dollar_price, 1) }}
                                                    </th>
                                                    <th class="hide_print">{{ number_format($item->other_costs) }}</th>
                                                    <th class="hide_print">{{ number_format($item->total_boundsd) }}
                                                    </th>
                                                    <th>{{ $item->notes }}</th>
                                        ...
                                        <tr>
                                            ...
                                            <tr class="hide_print">
                                                ...
                                                <th class="">{{ number_format($process->sum('total_boundsd')) }}
                                                </th>
                                    ...
                                    <table class="table table-bordered hide_print">
                                        <tr>
                                            ...
                                            <th>{{ number_format($process->sum('agreement_amount') - $process->sum('total_boundsd')) }}
                                            </th>
