...
<div class="container">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br>
                <form action="{{route('exchange_save')}}" method="POST" class="form-horizontal form-label-left">
                    @csrf
                                                            ...
                                                            @csrf
                                                                ...
                                                                <div class="form-group container" style="margin-bottom: 5px">
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                                                        <select  required name="debtor" style="width: 100%" class="select_2 form-control">
                                                                ...
                                                                <div class="form-group container" style="margin-bottom: 5px">
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                                                        <select  required name="Creditor" style="width: 100%" class="select_2 form-control">
