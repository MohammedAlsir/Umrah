                                ...
                                @foreach ($process as $item)
                                    <tr>
                                       ...
                                       <td>
                                        ...
                                        <td>
                                            <form  action="{{route('final_delivery.update',$item->id)}}" method="POST">
                                                {{ csrf_field()}}
                                                {{ method_field('put') }}
                                                @if ($item->status ==0)
                                                <button type="submit" style="width: 100%;margin: 5px 0 0 0px;" class="btn btn-success"><i
                                                        class="fa fa-check-circle  m-right-xs"></i>&nbsp; تسليم</button>
                                                @elseif($item->status ==1)

                                                <button type="button" style="width: 100%;margin: 5px 0 0 0px;" class="show_confirm2 btn btn-danger"><i
                                                        class="fa fa-times-circle   m-right-xs"></i>&nbsp; إلغاء التسليم</button>
                                                @endif

                                                 <a href="{{route('Account_statement.show',$item->agent->tree4_code)}}" type="button" style="width: 100%;margin: 5px 0 0 0px;" class="btn btn-success"><i
