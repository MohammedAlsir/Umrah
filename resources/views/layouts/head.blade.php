<head>
    ...
    <title>نظام الاستخدام الخارجي</title>
    ...
    <!-- iCheck -->
    <link href="{{ asset('vendors/iCheck/skins/flat/green.css') }}" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('ps://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/6.6.9/sweetalert2.min.css') }}">
  ...
  {{-- <link rel="stylesheet" href='css/sweetalert2.css'> --}}
    ...
    {{-- <link href="{{ asset('build/css/sweetalert2.css') }}" rel="stylesheet"> --}}
