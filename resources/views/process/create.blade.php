            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div id="gender" class="btn-group" data-toggle="buttons">
                        <label id="one" class="btn btn-default active" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                            <input type="radio"> &nbsp; دفع اجل &nbsp;
                        </label>

                        <label id="two" class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                            <input data-bs-toggle="modal" data-bs-target="#exampleModal" type="radio" name="gender" value="female" data-parsley-multiple="gender"> دفع نقدي
                        </label>
                    </div>
                </div>
            </div>
