...
{{-- @include('sweetalert::alert') --}}
 <div class="x_panel">
    ...
    <div class="x_content">
        <br/>
        <form  method="POST" action="{{route('users.update',$user->id)}}" id="demo-form2"  class="form-horizontal form-label-left">
            @csrf
            {{ method_field('put') }}
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="password" name="password" id="last-name"
             ...
             <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input  name="agent_status" {{$user->agent_status == 'on'? 'checked':''}} type="checkbox" class="js-switch" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input  name="company_status" {{$user->company_status == 'on'? 'checked':''}} type="checkbox" class="js-switch" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input  name="requirement_status" {{$user->requirement_status == 'on'? 'checked':''}} type="checkbox" class="js-switch" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input  name="process_status" {{$user->process_status == 'on'? 'checked':''}} type="checkbox" class="js-switch" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input  name="ticket_status" {{$user->ticket_status == 'on'? 'checked':''}} type="checkbox" class="js-switch" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input  name="final_delivery_status" {{$user->final_delivery_status == 'on'? 'checked':''}} type="checkbox" class="js-switch" />
                </div>
            </div>
             ...
             <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input  name="trees_status" {{$user->trees_status == 'on'? 'checked':''}} type="checkbox" class="js-switch" />
                </div>
            </div>
             ...
             <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input  name="accounts_status" {{$user->accounts_status == 'on'? 'checked':''}} type="checkbox" class="js-switch" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input  name="check_account_status" {{$user->check_account_status == 'on'? 'checked':''}} type="checkbox" class="js-switch" />
                </div>
            </div>
             ...
             <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input  name="users_status" {{$user->users_status == 'on'? 'checked':''}} type="checkbox" class="js-switch" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input  name="report_status" {{$user->report_status == 'on'? 'checked':''}} type="checkbox" class="js-switch" />
                </div>
            </div>
             ...
             <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input  name="dollar_price_status" {{$user->dollar_price_status == 'on'? 'checked':''}} type="checkbox" class="js-switch" />
                </div>
            </div>
             ...
             <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input name="setting_status" {{$user->setting_status == 'on'? 'checked':''}} type="checkbox" class="js-switch" />
                </div>
            </div>
