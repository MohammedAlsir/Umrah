                                ...
                                @foreach ($process as $item)
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                <button type="button" style="width: 100%; margin: 5px;" class="btn btn-primary  edit_data" data-toggle="modal"
                                                        data-target=".bs-example-modal-lg_{{$item->id}}">المزيد
                                                        <i class="fa fa-eye"></i>
                                                </button>
                                                 <a href="{{route('process.show',$item->id)}}" style="width: 100%; margin: 5px;" class="btn btn-default">عرض
                                                        <i class="fa fa-eye"></i>
                                                </a>
