                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_title">
                                ...
                                <button onClick="window.print()" style="padding-left: 20px; padding-right: 20px" class="btn btn-sm btn-default" type="button" data-placement="top" data-toggle="tooltip" data-original-title="طباعة">
                                    <i class="fa fa-print" style="margin-left:5px; margin-right:5px"></i>طباعة</button>
                                        ...
                                        <a href="{{route('receipt')}}" style="padding-left: 20px; padding-right: 20px" class="btn btn-sm btn-default" type="button" data-placement="top" data-toggle="tooltip" data-original-title="رجوع">
                            ...
                            <div class="x_content">
                                ...
                                <div class="bs-example" data-example-id="simple-jumbotron">
                                    ...
                                    <h2 class="text-center" style="clear:both; margin-top:30px">سند قبض</h2>
