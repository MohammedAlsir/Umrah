        ...
        <div class="x_content">
            ...
            <form method="POST" action="{{ route('ticket.store') }}" id="demo-form2" class="form-horizontal form-label-left">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="number" name="price" required="required" class="form-control col-md-7 col-xs-12"
                            value="">
                    </div>
                </div>

                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12"> تكلفة التذكرة
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12"> صافى التذكرة
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="number" name="net" required="required" class="form-control col-md-7 col-xs-12"
                            value="">
                    </div>
                </div>

                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12"> ربح التذكرة
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="number" name="profit" required="required" class="form-control col-md-7 col-xs-12"
                            value="">
                    </div>
                </div>
