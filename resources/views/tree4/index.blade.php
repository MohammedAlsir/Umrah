        ...
        <div class="x_content">
            ...
            <form action="{{route('tree4.store')}}" method="POST" class="form-horizontal form-label-left">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-9">
                        <select required name="tree3_code" style="width: 100%" class="select_2 form-control">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-9">
                        <input required type="text" name="tree4_name" class="form-control">
                    </div>
                </div>
                                    ...
                                    <div class="modal fade bs-example-modal-lg_{{$tree->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{route('tree4.update',$tree->id)}}" method="POST" class="form-horizontal form-label-left">
                                                    <div class="modal-body">
                                                           @csrf
                                                            ...
                                                            <div class="form-group container">
                                                                <label class="control-label col-md-3 col-sm-3 col-xs-3"> الحساب الرئيسي</label>
                                                                <div class="col-md-9 col-sm-9 col-xs-9">
                                                                    {{-- <input style="width: 100%; margin-bottom: 10px" value="{{$tree->tree3->tree3_name}}" disabled class="form-control"> --}}
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group container">
                                                                <label class="control-label col-md-3 col-sm-3 col-xs-3">رقم الحساب</label>
                                                                <div class="col-md-9 col-sm-9 col-xs-9">
                                                                    <input style="width: 100%; margin-bottom: 10px" value="{{$tree->tree4_code}}" disabled class="form-control">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group container">
                                                                <label class="control-label col-md-3 col-sm-3 col-xs-3">اسم الحساب</label>
                                                                <div class="col-md-9 col-sm-9 col-xs-9">
                                                                    <input style="width: 100%; margin-bottom: 10px" value="{{$tree->tree4_name}}" required type="text" name="tree4_name" class="form-control">
                                                                </div>
                                                            </div>
                                                    </div>
